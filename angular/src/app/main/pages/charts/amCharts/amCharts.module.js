...
(function () {
  ...
  angular.module('AccessControlSystem.main.pages.charts.amCharts', [])
      .config(routeConfig).config(amChartConfig);

  /** @ngInject */
  function routeConfig($stateProvider) {
    $stateProvider
        .state('app.main.pages.charts.amCharts', {
          url: '/amCharts',
          templateUrl: 'app/main/pages/charts/amCharts/charts.html',
          title: 'amCharts',
          sidebarMeta: {
            order: 0,
          },
